...
Nós utilizamos a abordagem do \foreign{learnersourcing} com o intuito de que os alunos, através de sua própria experiência resolvendo exercícios, podem criar dicas úteis através de suas implementações ou \foreign{bugs} que resolvem. Estes alunos podem então gerar sugestões para colegas com base em sua própria perícia. Mostraremos que, dada essa escolha de \foreign{design}, os alunos podem criar dicas que 

Nós apresentamos os fluxos de tralalho que colhem e organizam o conhecimento coletivo dos alunos e conselhos para ajudar os companheiros novatos através de exercícios de programação. 
